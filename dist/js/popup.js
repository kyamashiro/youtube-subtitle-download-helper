...
class CaptionsParser {
    ...
    pullTime(aline) {
        ...
        return new timestamp_1.Timestamp(this.getTimeFromText(startRegex, aline), this.getTimeFromText(durRegex, aline));
    }
    /**
     * Execute RegExp.
     *
...
exports.CaptionsParser = CaptionsParser;
...
const captionsParser_1 = __webpack_require__(/*! ./captionsParser */ "./src/captionsParser.ts");
class Converter {
     ...
     */
    toCsv() {
        const parser = new captionsParser_1.CaptionsParser();
...
function download() {
    ...
    client
        ...
        const subtitle = new subtitle_1.Subtitle(xmlResponse);
        if (format === "csv") {
...
class Subtitle {
    ...
    getVtt(filename) {
        json_2_csv_1.default
            .json2csvAsync(new converter_1.Converter(this.xmlResponse).toVtt(), options)
            .then((csv) => {
    ...
    getSrt(filename) {
        json_2_csv_1.default
            .json2csvAsync(new converter_1.Converter(this.xmlResponse).toSrt(), options)
            .then((csv) => {
            chrome.downloads.download({
    ...
    getLrc(filename) {
        json_2_csv_1.default
            .json2csvAsync(new converter_1.Converter(this.xmlResponse).toLrc(), options)
            .then((csv) => {
            chrome.downloads.download({
    ...
    getCsv(filename) {
        json_2_csv_1.default
            .json2csvAsync(new converter_1.Converter(this.xmlResponse).toCsv(), {
            excelBOM: true,
        })
            .then((csv) => {
            chrome.downloads.download({
    ...
    getText(filename) {
        json_2_csv_1.default
            .json2csvAsync(new converter_1.Converter(this.xmlResponse).toText(), options)
            .then((csv) => {
            chrome.downloads.download({
