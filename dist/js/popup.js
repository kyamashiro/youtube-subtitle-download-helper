...
function addSelectBoxFormat() {
    document
        ...
        .insertAdjacentHTML('afterbegin', "<select class='uk-select' style='margin-bottom:5px' id='format'><option value='csv'>.csv</option><option value='text'>.txt</option><option value='vtt'>.vtt</option></select>");
}
...
function download() {
    ...
    const format = document.getElementById('format')
        .value;
    getRequest(new url_1.default(language_url).getSubtitleUrl(format))
        .then(response => {
        if (!response)
